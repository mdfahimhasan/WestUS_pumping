...
**Direct download:**  
The annual groundwater pumping/total irrigation estimates (2000-2023) are available in the following GitHub directory for direct download. Users can directly download it and open it using any GIS software such as QGIS.
```
