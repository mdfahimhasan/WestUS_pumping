...
def process_dataset_for_LOBO(model_version, basin_code, basin_shape,
...
if __name__ == '__main__':
    ...
    # # GMD3, KS
    process_dataset_for_LOBO(model_version=model_version, basin_code='GMD3',
    ...
    # # GMD4, KS
    process_dataset_for_LOBO(model_version=model_version, basin_code='GMD4',
